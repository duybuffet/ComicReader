...
-- -----------------------------------------------------
-- Table `comicreader`.`view`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `comicreader`.`view` ;

CREATE TABLE IF NOT EXISTS `comicreader`.`view` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `view` INT NOT NULL,
...
CREATE INDEX `fk_view_1_idx` ON `comicreader`.`view` (`ebook_id` ASC);
...
CREATE UNIQUE INDEX `description_UNIQUE` ON `comicreader`.`feedback` (`description` ASC);
